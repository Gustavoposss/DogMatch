...
export default function AddPetScreen({ navigation }: NavigationProps) {
  const { state } = useAuth();
  ...
  const handleSubmit = async () => {
    ...
    if (!photoUri) {
      Alert.alert('Erro', 'Adicione uma foto do seu pet');
      return;
    }
    ...
    try {
      ...
      // Navegar de volta e forçar atualização da lista
